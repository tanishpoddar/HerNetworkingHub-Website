export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-border-dark mt-16">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col items-center justify-center gap-4">
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 animate-fade-in-up">
            ...
            <a 
              href="https://www.instagram.com/hernetworkinghub" 
              target="_blank" 
          ...
          <p className="text-xs sm:text-sm text-white/50 text-center px-4 whitespace-nowrap" suppressHydrationWarning>
            © {currentYear} HerNetworkingHub. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
